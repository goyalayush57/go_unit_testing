...
//Auto Generated Code
// func TestAPI_DoStuff(t *testing.T) {
// 	type fields struct {
// 		Client  *http.Client
// 		baseURL string
// 	}
...
// 				t.Errorf("API.DoStuff() got1 = %v, want %v", got1, tt.want1)
// 			}
// 		})
// 	}
// }
...
func NewTestClient(fn RoundTripFuncMock) *http.Client {
	return &http.Client{
		Transport: RoundTripFuncMock(fn),
	}
}
